...
int main(int argc, char *argv[])
{
	...
	(
		...
		(
			...
			(
				...
				Material(EMIT, { 1.0f, 1.0f, 1.0f }, { 100.0f, 100.0f, 100.0f })
			)
			)
	);
	scene.add
	...
	//scene.add(dynamic_cast<Object*>(new Mesh(Vector3d(278.0f, 273.0f, 273.0f), "objFile/teddy.obj", Material(SPEC, Vector3d(0.1, 0.1, 1.0)))));
